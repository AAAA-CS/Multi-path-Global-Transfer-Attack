...
from Targeted_Models.utils import grouper, sliding_window, count_sliding_window,\
                  camel_to_snake
...
class HamidaEtAl(nn.Module):        # 3D
    ...
    def __init__(self, input_channels=103, n_classes=9, patch_size=32, dilation=1):
...
class LuoEtAl(nn.Module):       # 3D
    ...
    def __init__(self, input_channels, n_classes, patch_size=3, n_planes=16):
        ...
        self.conv1 = nn.Conv3d(1, 16, (24, 3, 3), padding=0, stride=(9,1,1))
        self.conv2 = nn.Conv2d(1, 9, (3, 3), stride=(1, 1))

        self.features_size = self._get_final_flattened_size()

        self.fc1 = nn.Linear(self.features_size, 16)
